...
let airportData = "https://raw.githubusercontent.com/mfink13/Mapping_Earthquakes/main/majorAirports.json";
...
d3.json(airportData).then(function(data) {
  ...
  L.geoJSON(data, {
    onEachFeature: function(features, layer){
          console.log(layer);
          layer.bindPopup("<h2>Airport code: " + features.properties.faa + "</h2>" + "<h3> Airport name: " + features.properties.name + "</h3>")
      }
  }).addTo(map);
});
